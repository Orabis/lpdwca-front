...
export const advantages: Advantage[] = [
  {
    ...
    description: 'Adaptez vos cours à vos engagements et obligations existants.',
  },
  {
    id: 2,
    number: '02',
    title: 'Enseignement par des experts',
    description: "Apprenez auprès d'experts du secteur qui possèdent une expérience pratique dans le développement.",
  },
  {
    id: 3,
    number: '03',
    title: 'Formations variées',
    description: 'Découvrez un large éventail de cours de conception et de développement.',
  },
  {
    id: 4,
    number: '04',
    title: "Programme d'études mis à jour",
    description: 'Accédez à des cours dont le contenu est actualisé et reflète les dernières tendances du secteur.',
  },
  {
    id: 5,
    number: '05',
    title: 'Projets pratiques et devoirs',
    description: 'Créez un portfolio présentant vos compétences et vos aptitudes à des employeurs potentiels.',
  },
  {
    id: 6,
    number: '06',
    title: 'Interactive Learning Environment',
    description: "Collaborez avec d'autres apprenants, échangez des idées pour améliorer votre compréhension.",
  },
]
...
export const courses: Course[] = [
  ...
  },
  {
    ...
    description: "Plongez dans l'univers du développement d'applications mobiles. Apprenez à créer des applications.",
    href: '/licence/',
